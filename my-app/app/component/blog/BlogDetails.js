...
export default function BlogDetails({id})
{
    ...
    return (<>
            <div className="container">
                ...
                {/* Logo (desktop) */}
                <img src="/logo.PNG" className="img-fluid d-none d-md-block pt-3 img-blog-desktop" />
                {/* Logo (mobile) */}
                <img src="/logo.PNG" className="img-fluid d-block d-md-none pt-3" />
                </div>
            </div>
            <div className="row">
            ...
            <div className="row d-flex justify-content-center align-items-center">
                <img src="/logo.PNG" className="img-fluid  pt-3 img-2-index"/>
            </div>
            <div className="row">
